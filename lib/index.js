...
const defaults = {
  latestQuantity: 3,
  // Default number of posts in latest posts list
  featuredQuantity: 3,
  // Default number of posts in featured posts list
  featuredPostOrder: 'desc',
  // Default order for featured posts (high to low)
  fileExtension: '.md',
  // Default file extension for blog posts
  blogDirectory: './blog',
  // Default relative path to blog directory
  blogObject: 'post',
  // Default object name in frontmatter containing blog properties
